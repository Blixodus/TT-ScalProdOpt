...
if __name__ == "__main__":
    ...
    random_1_20 = lambda x : rng.integers(low=1, high=21) #21
    random_2_20 = lambda x : rng.integers(low=2, high=21) #21
    random_3_20 = lambda x : rng.integers(low=2, high=21) #21

    for amount in range(50):
        for inst in range(51, 101):
            ...
            file = open("uniform_pt2/instance_{}_{}.txt".format(inst_str, amount_str), "w")
            generate_instance(file, inst, random_1_20, random_2_20, random_3_20, True)
            file.close()