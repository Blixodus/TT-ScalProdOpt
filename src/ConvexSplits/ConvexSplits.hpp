...
class ConvexSplits : public Algorithm{
    ...
    cost_t solve_vertical(int i1, int i2, int j1, int j2, unsigned long long key,  vector_weight_t ext_cost_tab, cost_t S_cost);
    cost_t solve_diag(int i1, int i2, int j1, int j2, unsigned long long key, vector_weight_t const& ext_cost_tab, cost_t S_cost);

    void ext_cost(int i1, int i2, int j1, int j2, vector_weight_t const& ext_cost_tab, cost_t& s);
